              ...
              child: Row(
                  children: selectedDiningHall.meals.map((e) => Expanded(
                    child: CupertinoButton(
                      ...
                      color: selectedMeal == e.name ? SC_MAIN : null,
                      onPressed: () {
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text("${DateFormat("jm").format(e.open.toLocal())} - ${DateFormat("jm").format(e.close.toLocal())}", style: TextStyle(fontSize: 13, color: selectedMeal == e.name ? Colors.white : SC_MAIN)),
                        ],
                      ),
                    ),
                  )).toList()
              ...
              child: Container(
                ...
                child: Row(
                  ...
                  children: dates.map((e) => SizedBox(
                    width: 45,
                    child: CupertinoButton(
                      color: e.day == selectedDate.day ? SC_MAIN : null,
                      padding: EdgeInsets.zero,
                      onPressed: () {
                        setState(() {
                          selectedDate = e;
                      ...
                      child: Column(
                        children: [
                          ...
                          Text(DateFormat("MMM").format(e), style: TextStyle(fontSize: 13, color: e.day == selectedDate.day ? Colors.white : SC_MAIN)),
                        ],
                      ),
                    ),
                  )).toList()
