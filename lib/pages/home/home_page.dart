    ...
    try {
      ...
      setState(() {
        selectedArticle = NewsArticle.fromJson({
          'headline': "Munger Hall’s Architectural Consultant Resigns in Protest of Its Construction",
          'byline': "Asumi Shuda",
          'date': DateTime.parse("2020-10-28"),
          'excerpt': "The letter was published on Reddit on Oct. 26 following the Oct. 5 Design Review Committee (DRC) meeting.",
          'coverUrl': "https://dailynexus.s3.us-west-1.amazonaws.com/dailynexus/wp-content/uploads/2021/10/27175455/uc-santa-barbara-munger-hall-exterior___CourtesyofUCSBCurrent-1-430x330.jpg",
          'articleUrl': "https://dailynexus.com/2021-10-28/munger-halls-architectural-consultant-resigns-in-protest-of-its-construction/",
        });
      });
    } catch(e) {
      CoolAlert.show(
